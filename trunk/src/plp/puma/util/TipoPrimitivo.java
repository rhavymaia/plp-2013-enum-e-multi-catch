...
public class TipoPrimitivo implements Tipo {
	...
	/**
	 * 
	 * Por questao de simplificacao, este método foi implementado para unificar
	 * TipoPrimitivo e TipoClasse em uma única interface: Tipo
	 * 
	 */
	...
	public boolean equals(Object obj) {
		...
		else if (obj instanceof TipoClasse) {
			boolean resposta = false;
			if (this.tipo == INTEIRO && ((TipoClasse) obj).eInteiro())
				resposta = true;
			else if (this.tipo == BOOLEANO && ((TipoClasse) obj).eBooleano())
				resposta = true;
			else if (this.tipo == STRING && ((TipoClasse) obj).eString())
				resposta = true;
			return resposta;
		}
		return false;
