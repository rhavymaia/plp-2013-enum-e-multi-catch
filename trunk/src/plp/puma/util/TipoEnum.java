...
public class TipoEnum implements Tipo {
	...
	public static final Tipo TIPO_NULL = new TipoEnum(NULL);
	/** Constante de tipo String. */
	public static final Tipo TIPO_STRING = new TipoEnum(STRING);
	/** Constante de tipo Inteiro. */
	public static final Tipo TIPO_INTEGER = new TipoEnum(INTEGER);
	/** Constante de tipo Booleano. */
	public static final Tipo TIPO_BOOLEANO = new TipoEnum(BOOLEANO);
	/** Constante de tipo Enum. */
	public static final Tipo TIPO_ENUM = new TipoEnum(ENUM);
	 ...
	 * @param generic
	 */
	public TipoEnum(TipoGeneric generic) {
	...
	public boolean equals(Object obj) {
		if (obj instanceof TipoEnum)
			return tipoClasse.equals(((TipoEnum) obj).getTipo());
