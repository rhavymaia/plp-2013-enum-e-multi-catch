...
import plp.imperative1.command.ComandoDeclaracao;
import plp.imperative1.command.IO;
import plp.imperative1.command.IfThenElse;
import plp.imperative1.command.Read;
import plp.imperative1.command.SequenciaComando;
import plp.imperative1.command.Skip;
import plp.imperative1.command.While;
import plp.imperative1.command.Write;
import plp.imperative1.declaration.Declaracao;
import plp.imperative1.declaration.DeclaracaoComposta;
import plp.imperative1.declaration.DeclaracaoVariavel;
...
public class Imp1Parser implements Imp1ParserConstants {
	...
	public static void main(String args[]) {
		...
		if (args.length == 0) {
			System.out
					.println("Imperativa 1 PLP Parser Version 0.0.2:  Reading from standard input . . .");
			parser = new Imp1Parser(System.in);
		} else {
			System.out
					.println("Imperativa 1 PLP Parser Version 0.0.2:  Reading from file "
							+ args[0] + " . . .");
			try {
		 ...
		 * "Imperativa 1 PLP Parser Version 0.0.2:  Usage is one of:");
		 * System.out.println("         java Imp2Parser < inputfile");
		 * System.out.println("OR");
		 * System.out.println("         java Imp2Parser inputfile"); return; }
		 */
		try {
			Programa programa = parser.Input();
			System.out
					.println("Imperativa 1 PLP Parser Version 0.0.2:  Imperativa2 program parsed successfully.");
			if (programa.checaTipo(new ContextoCompilacaoImperativa(entrada))) {
				ListaValor saida = programa
						.executar(new ContextoExecucaoImperativa(entrada));
			...
			System.out
					.println("Imperativa 1 PLP Parser Version 0.0.2:  Encountered errors during parse.");
			e.printStackTrace();
		}
	}
	...
	static final public SequenciaComando PSequenciaComando()
	...
	static final public ComandoDeclaracao PComandoDeclaracao()
			throws ParseException {
		Declaracao dec;
		Comando comando;
	...
	static final public Declaracao PDeclaracaoSimples() throws ParseException {
		Declaracao retorno;
		switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
		case VAR:
	...
	static final public DeclaracaoComposta PDeclaracaoComposta()
			throws ParseException {
		Declaracao d1;
		Declaracao d2;
		d1 = PDeclaracaoSimples();
	...
	static final public DeclaracaoVariavel PDeclaracaoVariavel()
			throws ParseException {
		Id id;
		Expressao exp;
	...
	private static void jj_la1_init_0() {
		jj_la1_0 = new int[] { 0x3b0000, 0x180000, 0x6000, 0x20006000,
				0x20006000, 0x1800, 0x20006000, 0x20006000, 0x3b0000, 0x8000,
				0x8000, };
	}

	private static void jj_la1_init_1() {
		jj_la1_1 = new int[] { 0xa4, 0x0, 0x0, 0x2, 0x26, 0x40000000, 0x26,
				0x26, 0xa4, 0x20, 0x20, };
	}
