...
import plp.expressions2.Programa;
...
public class Exp2Parser implements Exp2ParserConstants {
	...
	public static void main(String args[]) {
		...
		if (args.length == 0) {
			System.out
					.println("Expressoes 2 PLP Parser Version 0.0.1:  Reading from standard input . . .");
			parser = new Exp2Parser(System.in);
		} else if (args.length == 1) {
			System.out
					.println("Expressoes 2 PLP Parser Version 0.0.1:  Reading from file "
							+ args[0] + " . . .");
			try {
				parser = new Exp2Parser(new java.io.FileInputStream(args[0]));
			} catch (java.io.FileNotFoundException e) {
				System.out
						.println("Expressoes 2 PLP Parser Version 0.0.1:  File "
								+ args[0] + " not found.");
				return;
			}
		} else {
			System.out
					.println("Expressoes 2 PLP Parser Version 0.0.1:  Usage is one of:");
		...
		try {
			...
			System.out
					.println("Expressoes 2 PLP Parser Version 0.0.1:  Expressoes2 program parsed successfully.");
			try {
			...
			e.printStackTrace();
			System.out
					.println("Expressoes 2 PLP Parser Version 0.0.1:  Encountered errors during parse.");
		}
	}
	...
	static final public List PDeclVar() throws ParseException {
		...
		label_1: while (true) {
			...
			jj_consume_token(ASSIGN);
			expressao = PExpressao();
			// retorno.add (0, new DecVariavel(id, expressao));
			retorno.add(new DecVariavel(id, expressao));
		}
		{
			if (true)
	...
	private static void jj_la1_init_0() {
		jj_la1_0 = new int[] { 0x6000, 0x446000, 0x4c46000, 0x0, 0x4c4f800,
				0x600, 0x600, };
	}

	private static void jj_la1_init_1() {
		jj_la1_1 = new int[] { 0x0, 0x0, 0x0, 0x2, 0x40000, 0x70400, 0x70400, };
	}
